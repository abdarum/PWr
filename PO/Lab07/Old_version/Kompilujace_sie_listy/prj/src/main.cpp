...
int main()
{
  ...
  int wybrany_robot=0,tmp_wybrany_robot=0;    
  ...
  Robot R1(Wektor2D(0,0),0);
  Przeszkoda R2(vector<double>{20,90,70,90,70,150,20,150});

  //  cout<<  R1.Punkt_Nalezy_Do_Prostokata(*R2,R1.Wektor_Translacji());
  
  /*
  Scena_programu.Animacja_Sciezki_FormatGnuplot(Lacze,"robot.dat",Scena_programu.Sciez[0],Scena_programu.Rob[0],Predkosc_Robota);
