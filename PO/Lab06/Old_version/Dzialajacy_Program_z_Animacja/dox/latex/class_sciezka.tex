...
\begin{DoxyCompactList}\small\item\em Funkcja wypisuje kolejne punkty posrednie do strumienia tworząc animację robota i ścieżki. \end{DoxyCompactList}\end{DoxyCompactItemize}
