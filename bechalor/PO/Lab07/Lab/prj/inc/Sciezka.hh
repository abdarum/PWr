...
public:
  ...
  Sciezka(std::vector<double> Wspolrzedne_Wierzcholkow,const double &Kat_Obrotu){Objekt_Graficzny(Wspolrzedne_Wierzcholkow,Kat_Obrotu);_obecny_punkt=0;}
  /*!
   * \brief Inicjalizacja zmiennej typu ZbiorWierzcholkow wartosciami
   *
   ...
   *                        domyślego położenia
   */
  Sciezka(std::vector<Wektor2D> Wierzcholki,const double &Kat_Obrotu){Objekt_Graficzny(Wierzcholki,Kat_Obrotu);_obecny_punkt=0;}
  /*!
   * \brief Inicjalizacja zmiennej typu ZbiorWierzcholkow wartosciami
   *
   * \param[in] Wspolrzedne_Wierzcholkow ustawia parametry wspolrzednych
   ...
   *                        wierzcholkow. 
   */
  Sciezka(Wektor2D Wierzcholki){Objekt_Graficzny(); Objekt_Graficzny::Ustaw(Wierzcholki);_obecny_punkt=0;}
  /*!
   * \brief Funkcja odpowiada obliczenie punktu docelowego ruchu
   *
   ...
   */
  void Przygotuj_Animacje_Sciezki(Robot& Rob,const  std::list<std::shared_ptr<Objekt_Graficzny>> &objekty,double dlugosc=1);
  /*!
   ...
   */
  virtual Tryb_Pracy Rodzaj_Obiektu(){return Ob_Sciezka;}
  /*!
   * \brief Zwraca tryb pracy w którym pracuje Obiekt_Graficzny
   */
  virtual std::string Rodzaj_Obiektu_Nazwa() const {return "Sciezka";}
