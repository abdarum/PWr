 ...
 */
enum Tryb_Pracy { Ob_Obiekt_Graficzny, Ob_Robot, Ob_Sciezka, Ob_Przeszkoda}; 
...
public:
 ...
 /*!
   ...
   */
  virtual Tryb_Pracy Rodzaj_Obiektu(){return Ob_Obiekt_Graficzny;}
  /*!
   * \brief Zwraca tryb pracy w którym pracuje Obiekt_Graficzny
   */
  virtual std::string Rodzaj_Obiektu_Nazwa() const {return "Obiekt_Graficzny";}
  /*!
