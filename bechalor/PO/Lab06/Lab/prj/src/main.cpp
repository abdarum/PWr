...
int main()
{
  ...
  Wektor2D _domyslne_wartosci_wektora_globalnego=Wektor2D(100,50);
  ...
  if(!Scena_programu.Animacja_Obrotu_FormatGnuplot(Lacze,"prostokat.dat",Scena_programu.Sciez,Scena_programu.Rob))
    return 1;
  cin>>dlugosc;
  ...
  //  if (!Scena_programu.ZapisWspolrzednychDoPlikuFormatGnuplot("prostokat.dat")) 
  if(!Scena_programu.Animacja_Sciezki_FormatGnuplot(Lacze,"prostokat.dat",Scena_programu.Sciez,Scena_programu.Rob))
    return 1;
  ...
  */  
  ...
  while(Znak!='k')
	...
	case 'j':
	  ...
	  cin>>dlugosc;
	  Scena_programu.Sciez.Jedz_Prosto(Scena_programu.Rob,dlugosc);
	  if(!Scena_programu.Animacja_Sciezki_FormatGnuplot(Lacze,"prostokat.dat",Scena_programu.Sciez,Scena_programu.Rob,Predkosc_Robota))
	    return 1;
	  cout<<Scena_programu.Sciez.Laczna_Dlugosc_Sciezki()<<endl;
	  break;	 
