...
void WyrazenieAlgeb::Zeruj()
{
  Arg1=e;
  ZnakDzialania='~';
  Arg2=e;
  WczytanyWynikDzialania=e;
  PrawidlowyWynikDzialania=e;
  WynikiRowne=false;
}


void WyrazenieAlgeb::WykonajDzialania(Statystyka& Stat)
{
